...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    bool postfork = nHeight >= params.ANCHeight;
    ...
    else if (nHeight < params.ANCHeight + params.ANCDiffdropWindow) {
        return nProofOfWorkLimit;
    }
    else if (nHeight < params.ANCHeight + params.ANCDiffdropWindow + params.nPowAveragingWindow){
