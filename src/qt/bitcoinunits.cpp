...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case ANC: return QString("Bitcoins");
    case mANC: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uANC: return QString("Micro-Bitcoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
