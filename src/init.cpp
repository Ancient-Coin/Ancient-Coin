 ...
 * between ancicoind, and bitcoin-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Ancient Coin bootstrap mode. Allows ANC client to connect to Bitcoin p2p network to download blockahin history."));
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    fANCBootstrapping = gArgs.GetBoolArg("-bootstrap", false);
