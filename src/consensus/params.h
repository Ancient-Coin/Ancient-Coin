...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which Ancient Coin hard fork becomes active */
    int ANCHeight;
    /** Mining blocks for Ancient Coin hard fork **/
    int ANCDiffdropWindow;
    int ANCPremineWindow;
    bool ANCPremineEnforceWhitelist;
