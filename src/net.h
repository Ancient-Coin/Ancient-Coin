...
public:
    ...
    // Whether the node uses the bitcoin ancient magic to communicate.
    std::atomic<bool> fUsesAncientMagic;
...
public:
    ...
    GetMagic(const CChainParams &params) const {
        return fUsesAncientMagic ? params.MessageStart()
    ...
    bool IsLegacyBlockHeader(int version) { return version < ANC_HARD_FORK_VERSION; };
};
