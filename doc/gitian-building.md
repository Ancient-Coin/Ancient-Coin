...
Output from `gbuild` will look something like
    ...
    From https://github.com/Ancient-Coin/Ancient-Coin
...
[Ancient-Coin/gitian.sigs](https://github.com/Ancient-Coin/gitian.sigs/) repository, or if that's not possible create a pull
